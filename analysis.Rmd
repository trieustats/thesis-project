...
# Changing the data in the entry_class into scores. str_replace(string, pattern, replacement) 
# strips off the space between words, dots and the letters that have Vietnamese diacritical marks.
